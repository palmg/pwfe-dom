...
var registerImgHandle = function registerImgHandle(id, callback) {
 ...
 * }
 */
var setImgFile = exports.setImgFile = function setImgFile(img) {
    __img = img;
    executeHandle();
};
...
var Icon = function (_React$Component) {
    ...
    _createClass(Icon, [{
        ...
        value: function loadImg(src) {
            var _this = this;
            registerImgHandle(src, function (img) {
                _this.setState({
                    img: img
                });
            });
        ...
        value: function render() {
            var props = Object.assign({}, this.props),
                img = this.state.img;
            props.src = img ? img : _empty2.default;
