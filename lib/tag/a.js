...
var outProps = ['match', 'location', 'history', 'staticContext', 'browser', 'server'];
 ...
 *  }
 */
var A = (0, _router.reRoute)()(function (_React$Component) {
    ...
    _createClass(_class, [{
        ...
        key: 'checkHref',
        value: function checkHref(props) {
            var _props2 = this.props,
                href = _props2.href,
                server = _props2.server,
                browser = _props2.browser;
            ...
            outProps.forEach(function (i) {
                return delete props[i];
            });
        }
    }, {
        key: 'render',
